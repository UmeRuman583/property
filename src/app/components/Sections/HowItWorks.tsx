...
const steps = [
  {
    ...
    description:
      "Receive a data-driven property valuation within 24 hours — with zero obligation.",
  },
  {
    number: 2,
    title: "Sign the agreement",
    description:
      "Experience peace of mind through a transparent, digitally-signed contract process.",
  },
  {
    number: 3,
    title: "Get rent-ready",
    description:
      "We’ll help prepare your property to attract top tenants and maximize appeal.",
  },
  {
    number: 4,
    title: "Receive monthly payments",
    description:
      "Relax with on-time, direct deposit payments — no stress, no delays.",
  },
];
