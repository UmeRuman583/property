...
const ForResidents = () => {
  return (
    ...
    <section id="for-residents" className="w-full bg-gray-100">
      {/* Top Heading Section (NOT in background image) */}
      ...
      <div
        ...
        style={{ backgroundImage: `url('/blue.png')` }} // ← Change to your image path
      >
...
>
  ...
  <h3 className="text-xl font-semibold text-gray-800 mb-2 pl-3">CreditFlow</h3>
...
>
  ...
  <div className="pl-4">
    <h3 className="text-xl font-semibold text-gray-800 mb-2">RENT A HOME</h3>
