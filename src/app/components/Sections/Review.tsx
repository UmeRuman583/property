...
const reviews = [
  {
    ...
    role: 'Homeowner',
    feedback:
      'Absolutely seamless! The platform made managing my property stress-free and transparent.',
  },
  {
    name: 'Fatima Khan',
    role: 'Resident',
    feedback:
      'I love the instant communication and ease of reporting issues. Highly recommend it!',
  },
  {
    name: 'John Smith',
    role: 'Homeowner',
    feedback:
      'Great support and intuitive design. It has made community living much better!',
  },
];
      ...
      <div className="max-w-7xl mx-auto px-24 flex flex-col md:flex-row justify-between items-center gap-12">
        ...
        <div className="md:w-1/2">
          <h2 className="text-4xl font-extrabold text-blue-900 leading-snug">
            What our <span className="text-yellow-600">Owners</span> and{' '}
            <span className="text-yellow-600">Residents</span> are saying <br /> <b>About us</b>
          </h2>
        </div>
